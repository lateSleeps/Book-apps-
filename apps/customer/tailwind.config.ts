  ...
  theme: {
    extend: {
      colors: {
        ...
        "c-salmon": "#E8705A",
        "bg-ticket": "#eeeef2",
        // ── Shared design system tokens (matches Owner App exactly) ──
        "bg-page": "#F2F2F7", // page shell background — iOS system gray 6 (matches Owner App)
        "bg-control": "#F2F2F7", // segmented tab container, icon buttons
        "bg-card": "#FFFFFF", // cards, panels, active tab pill
        "tx-primary": "#1C1C1E", // primary label
        "tx-secondary": "#8E8E93", // secondary label
        "tx-muted": "#C7C7CC", // muted / count
        "bd-card": "#E5E5EA", // card border
      ...
      boxShadow: {
        ...
        tab: "0 1px 4px rgba(0,0,0,0.1)", // active tab pill — matches Owner App
        card: "0 2px 8px rgba(0,0,0,0.06)", // cards — matches Owner App
      },
      keyframes: {
        sIn: {
